-- ============================================================
-- !! LIVE VARIANT !! [CODESPACE] -> [LIVE yylvtvbhddcepilzwpaw]  Tokyo
-- Derived from the sandbox original. ONE change: the guard is inverted.
-- Verified before deriving: column absent, notes pin present,
-- date_of_birth not yet pinned, caller_is_org_admin excludes managers.
...
begin
  ...
  -- INVERTED for LIVE. The sandbox original aborts ABOVE 30 to protect
  -- production; this copy aborts BELOW 30 so it cannot be run against
