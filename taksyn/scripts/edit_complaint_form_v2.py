...
def main():
    ...
    # Anchor widened to include the preceding `submitted` line so it is UNIQUE to
    # ReportIssueView (IssueReportsAdminView also has a `[issues,setIssues]` line).
    a1 = ("  const [submitted, setSubmitted] = useState(false)\n"
          "  const [issues, setIssues] = useState([])\n")
    r1 = ("  const [submitted, setSubmitted] = useState(false)\n"
          "  const [issues, setIssues] = useState([])\n"
