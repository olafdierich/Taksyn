...
def main():
    ...
    # ---- Edit 1: filterType state (anchor: filterStatus state line, unique to admin view) ----
    a1 = "  const [filterStatus, setFilterStatus] = useState('open')\n"
    r1 = ("  const [filterStatus, setFilterStatus] = useState('open')\n"
