...
const GUIDE_CONTENT = {
  client_admin: {
    ...
    chapters: [
      { num:1, title:'Your Role', subChapters:[
        { id:'1.1', title:'What Client Admins do', steps:[
          { summary:'Create and assign tasks to managers and supervisors', detail:'As Client Admin you are responsible for creating tasks and assigning them to the right managers and supervisors. Go to Tasks and click New Task to create a task. Fill in the title, description, checklist, priority, due date, and assign it to the appropriate person. The assigned person is notified immediately.', foundIn:'Left sidebar → Tasks → New Task button', tip:'Write task descriptions clearly — the more detail you provide upfront the fewer questions your team will need to ask.' },
          { summary:'Review reports and compliance', detail:'Go to the Reports section to view compliance summaries, task completion rates, and audit records for your organisation. You can generate PDF reports and export CSV data. Use reports to stay on top of what is being completed, what is overdue, and whether compliance requirements are being met.', foundIn:'Left sidebar → Reports', tip:'Run a compliance report at the end of each week to catch any gaps before they become issues.' },
          { summary:'Monitor overall operations', detail:'Your Dashboard gives you a live view of all tasks across your organisation — how many are pending, in progress, awaiting review, completed, or overdue. Use the Tasks section with filters to drill into specific workers, roles, or time periods. The Performance section shows individual and team-level stats.', foundIn:'Dashboard, Left sidebar → Tasks, Left sidebar → Performance', tip:'A high Overdue count on your Dashboard is an early warning sign — investigate before tasks are missed entirely.' },
          { summary:'Support managers and supervisors', detail:'Managers and supervisors are your frontline task drivers. Support them by ensuring tasks are clearly defined, checklists are complete, and expectations are documented. If a manager or supervisor raises an escalation respond promptly — escalations indicate something needs your attention.', foundIn:'Left sidebar → Escalations', tip:'Review escalations daily. Unresolved escalations affect team morale and compliance records.' },
          { summary:'Manage workforce, teams and settings', detail:'Use the Workforce section to invite new team members, edit roles and positions, and manage your staff list. Use Teams to organise staff into groups. Go to Company Settings to configure your organisation profile, notification preferences, session timeout, and data retention.', foundIn:'Left sidebar → Workforce, Teams, Company Settings', tip:'Set up your industry, roles, and positions in Settings before inviting staff so the right options appear in the invite form.' },
        ]},
      ]},
    ]
  },
    ...
    chapters: [
      { num:1, title:'Your Role', subChapters:[
        { id:'1.1', title:'What Managers and Supervisors do', steps:[
          { summary:'Create and send tasks to workers', detail:'Go to Tasks and click New Task. Fill in the task title, description, priority, due date, and checklist. Select the worker from the Assigned To dropdown. Click Create Task — the worker is notified immediately and the task appears on their Dashboard. Use checklist templates for tasks with standard steps.', foundIn:'Left sidebar → Tasks → New Task button', tip:'A specific, well-described task gets done correctly the first time. Include what, where, and how in the description.' },
          { summary:'Review submitted tasks — approve or reject', detail:'When a worker submits a completed task it moves to Awaiting Review. Go to Tasks and filter by Awaiting Review, or tap the Awaiting Review count on your Dashboard. Open each task, check the photo evidence in the Evidence section, verify the checklist items are all ticked, then click Approve or Reject.', foundIn:'Dashboard → Awaiting Review count, or Tasks → filter by Awaiting Review', tip:'Check both the photo AND the checklist — the photo confirms the end result, the checklist confirms each step was done.' },
          { summary:'Reject tasks back to the worker with comments', detail:'If the work is not up to standard click Reject. You must type a reason in the rejection comment box — explain exactly what needs to be fixed. The worker receives a notification with your comment. The task returns to their queue so they can redo the work and resubmit.', foundIn:'Tasks → task detail → Reject button → rejection comment box', tip:'Always add a specific rejection comment — "Photo unclear, retake from further back" is far more useful than "Please redo".' },
          { summary:'Escalate issues', detail:'If a task or situation requires urgent attention from management click the Escalate button on the task. This flags it as an escalation and notifies the Client Admin. Use escalation for situations that are beyond your authority to resolve, involve safety, or require immediate action at a higher level.', foundIn:'Tasks → task detail → Escalate button', tip:'Escalate early rather than late — waiting too long can turn a minor issue into a major one.' },
          { summary:'Find and review tasks in the archive', detail:'Completed and old tasks move to the Archive. Go to Tasks and click the Archive tab or filter by archived status to find past tasks. The archive is your compliance record — use it to review past work, find patterns, or respond to audit requests. You can export archived task data from the Reports section.', foundIn:'Left sidebar → Tasks → Archive tab', tip:'Check the archive regularly for tasks that were completed but never formally approved — they may still need your review.' },
          { summary:'Edit and delete tasks', detail:'To edit a task open it and click the Edit button. You can update the title, description, checklist, due date, priority, and assigned worker. To delete a task click Delete in the task detail view and confirm. Deleted tasks are removed from the active list but remain in the Audit Log.', foundIn:'Tasks → task detail → Edit button, Delete button', tip:'All task edits are recorded in the Audit Log with a timestamp and your name — there is always a record of what changed.' },
          { summary:'Monitor team performance', detail:'Go to the Performance section to see each team member\'s task completion rate, on-time percentage, average completion time, and number of rejections. Use the date filter to view weekly, monthly, or quarterly data. Export a PDF report for management meetings or performance reviews.', foundIn:'Left sidebar → Performance', tip:'Review Performance weekly to catch issues early. A sudden drop in one person\'s stats usually means they need support.' },
        ]},
      ]},
      { num:2, title:'Pitfalls to Avoid', subChapters:[
        { id:'2.1', title:'Common mistakes and how to avoid them', steps:[
          { summary:'Always add comments when rejecting tasks', detail:'Rejecting a task without a comment leaves the worker with no idea what to fix. They will either guess and resubmit something incorrect, or come to you for clarification — wasting everyone\'s time. Write a specific, actionable comment every time you reject. Explain exactly what was wrong and what a correct submission looks like.', foundIn:'Tasks → task detail → Reject button → rejection comment box', tip:'"Photo unclear — retake from 2 metres back showing the full room" is a good rejection comment. "Redo this" is not.' },
          { summary:'Check the archive regularly for overdue tasks', detail:'Tasks that were not completed before their due date sit in the archive as overdue. If you do not check the archive these tasks will be missed entirely. Make it a habit to review the archive at least weekly to catch any tasks that slipped through.', foundIn:'Left sidebar → Tasks → Archive tab', tip:'Filter the archive by Overdue status to see all tasks that were not completed on time. Follow up with the assigned worker.' },
          { summary:'Escalate early rather than late', detail:'If a situation is beyond your authority to handle, involves a safety concern, or is unlikely to be resolved in time — escalate immediately. Waiting too long turns a manageable problem into a missed deadline or a compliance breach. The Client Admin is there to support you — use the escalation function when you need it.', foundIn:'Tasks → task detail → Escalate button', tip:'When in doubt, escalate. It is always better to flag something early than to discover it was serious after the fact.' },
        ]},
      ]},
      { num:4, title:'Creating and Managing Tasks', subChapters:[
        { id:'4.1', title:'Creating and sending a task', steps:[
          { summary:'Go to Tasks in the left sidebar and click Create New Task', detail:'Navigate to the Tasks section using the left sidebar. Click the Create New Task button at the top of the page to open the task creation form.', foundIn:'Left sidebar → Tasks → Create New Task button', tip:'Always add checklist items so workers know exactly what is expected.' },
          { summary:'Fill in task title, role, position, priority, due date, assign to a worker and add checklist items', detail:'Complete the task form: enter a clear task title, select the role and position the task applies to, set the priority level, choose a due date, and select the worker from the Assigned To dropdown. Add checklist items to define the exact steps the worker needs to complete.', foundIn:'Create New Task form → Title, Role, Position, Priority, Due Date, Assigned To, Checklist fields', pitfall:'Make sure you assign the task to the correct worker before submitting.' },
          { summary:'Click Submit Task to send it to the worker', detail:'Once all fields are filled in click Submit Task. The task is sent immediately to the assigned worker. It appears on their Dashboard and they receive a notification.', foundIn:'Create New Task form → Submit Task button', tip:'Always add checklist items so workers know exactly what is expected.' },
        ]},
        { id:'4.2', title:'Reviewing submitted tasks', steps:[
          { summary:'Go to Tasks and filter by Awaiting Review', detail:'After a worker submits a task it moves to Awaiting Review status. Go to Tasks in the left sidebar and use the filter bar to select Awaiting Review. This shows all tasks that need your attention.', foundIn:'Left sidebar → Tasks → filter by Awaiting Review', tip:'Always add a comment when rejecting so the worker knows what to fix.' },
          { summary:'Open the task and review the checklist completions, photos and timestamps', detail:'Click on a task to open its detail view. Check that all required checklist items are ticked, review the photo evidence to confirm the work was done correctly, and check the timestamps to verify the task was completed at the right time.', foundIn:'Tasks → task detail → Checklist section, Evidence section, timestamps', pitfall:'Never approve a task with missing photos if photo evidence was required.' },
          { summary:'Click Approve to complete the task or Reject to send it back to the worker with comments', detail:'If the work meets the required standard click Approve — the task is marked as completed. If the work is not acceptable click Reject, type a clear reason in the rejection comment box, and submit. The worker receives your comment and the task returns to their queue for rework.', foundIn:'Task detail → Approve button or Reject button → rejection comment box', tip:'Always add a comment when rejecting so the worker knows what to fix.' },
        ]},
        { id:'4.3', title:'Editing, deleting and escalating tasks', steps:[
          { summary:'Open a task and click Edit to update details or Delete to remove it', detail:'Open any active task to see the Edit and Delete options. Click Edit to modify the task title, description, checklist, due date, priority, or assigned worker. Click Delete to permanently remove the task from the active list.', foundIn:'Tasks → task detail → Edit button, Delete button', pitfall:'Deleted tasks cannot be restored from the active list but remain in the Audit Log for compliance.' },
          { summary:'To flag an urgent issue click Escalate — the task moves to Escalations and notifies the client admin', detail:'If a task requires immediate attention from a higher level, open the task detail view and click the Escalate button. The task moves to the Escalations view and the Client Admin receives a notification so they can take action.', foundIn:'Tasks → task detail → Escalate button; Escalations view', tip:'Escalate early rather than late — do not wait until a deadline is missed.' },
          { summary:'Find completed or deleted tasks in the Archive — use filters to search by date, worker or status', detail:'The Archive contains all completed, approved, and old tasks. Go to Tasks and click the Archive tab. Use the filter and search tools to locate specific tasks by date range, assigned worker, or task status.', foundIn:'Left sidebar → Tasks → Archive tab → filter bar', tip:'Escalate early rather than late — do not wait until a deadline is missed.' },
        ]},
      ]},
    ]
  },
    ...
    chapters: [
      { num:1, title:'Your Role', subChapters:[
        { id:'1.1', title:'What Managers and Supervisors do', steps:[
          ...
          { summary:'Reject tasks back to the worker with comments', detail:'If the work is not up to standard click Reject. You must type a reason in the rejection comment box — explain exactly what needs to be fixed. The worker receives a notification with your comment. The task returns to their queue so they can redo the work and resubmit.', foundIn:'Tasks → task detail → Reject button → rejection comment box', tip:'Always add a specific rejection comment — "Photo unclear, retake from further back" is far more useful than "Please redo".' },
          { summary:'Escalate issues', detail:'If a task or situation requires urgent attention from management click the Escalate button on the task. This flags it as an escalation and notifies the Client Admin. Use escalation for situations that are beyond your authority to resolve, involve safety, or require immediate action at a higher level.', foundIn:'Tasks → task detail → Escalate button', tip:'Escalate early rather than late — waiting too long can turn a minor issue into a major one.' },
          { summary:'Find and review tasks in the archive', detail:'Completed and old tasks move to the Archive. Go to Tasks and click the Archive tab or filter by archived status to find past tasks. The archive is your compliance record — use it to review past work, find patterns, or respond to audit requests.', foundIn:'Left sidebar → Tasks → Archive tab', tip:'Check the archive regularly for tasks that were completed but never formally approved — they may still need your review.' },
          { summary:'Edit and delete tasks', detail:'To edit a task open it and click the Edit button. You can update the title, description, checklist, due date, priority, and assigned worker. To delete a task click Delete in the task detail view and confirm. Deleted tasks are removed from the active list but remain in the Audit Log.', foundIn:'Tasks → task detail → Edit button, Delete button', tip:'All task edits are recorded in the Audit Log with a timestamp and your name — there is always a record of what changed.' },
          { summary:'Monitor team performance', detail:'Go to the Performance section to see each team member\'s task completion rate, on-time percentage, average completion time, and number of rejections. Use the date filter to view weekly, monthly, or quarterly data. Export a PDF report for management meetings or performance reviews.', foundIn:'Left sidebar → Performance', tip:'Review Performance weekly to catch issues early. A sudden drop in one person\'s stats usually means they need support.' },
        ]},
      ]},
      { num:2, title:'Pitfalls to Avoid', subChapters:[
        { id:'2.1', title:'Common mistakes and how to avoid them', steps:[
          { summary:'Always add comments when rejecting tasks', detail:'Rejecting a task without a comment leaves the worker with no idea what to fix. They will either guess and resubmit something incorrect, or come to you for clarification — wasting everyone\'s time. Write a specific, actionable comment every time you reject. Explain exactly what was wrong and what a correct submission looks like.', foundIn:'Tasks → task detail → Reject button → rejection comment box', tip:'"Photo unclear — retake from 2 metres back showing the full room" is a good rejection comment. "Redo this" is not.' },
          { summary:'Check the archive regularly for overdue tasks', detail:'Tasks that were not completed before their due date sit in the archive as overdue. If you do not check the archive these tasks will be missed entirely. Make it a habit to review the archive at least weekly to catch any tasks that slipped through.', foundIn:'Left sidebar → Tasks → Archive tab', tip:'Filter the archive by Overdue status to see all tasks that were not completed on time. Follow up with the assigned worker.' },
          { summary:'Escalate early rather than late', detail:'If a situation is beyond your authority to handle, involves a safety concern, or is unlikely to be resolved in time — escalate immediately. Waiting too long turns a manageable problem into a missed deadline or a compliance breach. Management is there to support you — use the escalation function when you need it.', foundIn:'Tasks → task detail → Escalate button', tip:'When in doubt, escalate. It is always better to flag something early than to discover it was serious after the fact.' },
        ]},
      ]},
      { num:4, title:'Creating and Managing Tasks', subChapters:[
        { id:'4.1', title:'Creating and sending a task', steps:[
  ...
  worker: {
    ...
    chapters: [
      { num:1, title:'Your Role', subChapters:[
        { id:'1.1', title:'What Workers do', steps:[
          { summary:'Receive and complete assigned tasks', detail:'Your manager or supervisor creates tasks and assigns them to you. When a task is assigned you receive a notification and it appears on your Dashboard. Open each task to read the full details, description, and checklist before you start work.', foundIn:'Dashboard (home screen) → assigned tasks', tip:'Check your Dashboard at the start of every shift to see what tasks are waiting for you.' },
          { summary:'Time in and out to record when the task started and ended', detail:'When you are ready to begin a task open it and tap the Time In button. This records your official start time. When you finish the work tap the Time Out button. This records your end time. The duration is calculated automatically. Your manager can see both times.', foundIn:'Task detail → Time In button, Time Out button', tip:'Always tap Time In before you start work and Time Out as soon as you finish — these timestamps are part of your compliance record.' },
          { summary:'Complete checklist items with photos and timestamps', detail:'Work through the task checklist and tap the checkbox next to each item as you complete it. Items marked with a clock icon record the exact time you ticked them. When the work is done use the camera icon in the Evidence section to attach a clear photo showing the completed work.', foundIn:'Task detail → Checklist section → checkboxes; Evidence section → camera icon', tip:'Tick checklist items as you go, not all at once — individual timestamps prove each step was done at the right time.' },
          { summary:'Submit task for review when done', detail:'Once all checklist items are completed and your photo is attached tap the Submit button. The task moves to Awaiting Review and your manager receives a notification. You will be notified when your manager approves or rejects the task.', foundIn:'Task detail → Submit button', tip:'Once submitted you cannot edit the task. If you made a mistake contact your manager directly.' },
        ]},
      ]},
      { num:2, title:'Your Tasks', subChapters:[
        { id:'2.4', title:'Time In and Time Out', steps:[
          { summary:'Open your assigned task and tap the Time In button to record when you start', detail:'When you are ready to begin work open the task from your Dashboard and tap the Time In button. This records your official start time and updates the task status to In Progress. Your manager can see that you have started.', foundIn:'Task detail → Time In button', tip:'Always tap Time In before you start working — this is your proof of when you began.' },
          { summary:'Complete all checklist items, add photos and timestamps as required', detail:'Work through the checklist and tick each item as you complete it. Items with a clock icon will automatically record the time you ticked them. Add photos using the camera icon where required to provide evidence of your work.', foundIn:'Task detail → Checklist section → checkboxes; Evidence section → camera icon', pitfall:'Do not tap Submit without completing all mandatory checklist items marked with an asterisk.' },
          { summary:'Tap Time Out when you are finished, then tap Submit to send the task for review', detail:'When all work is done tap the Time Out button to record your finish time. Once Time Out is recorded tap the Submit button to send the task to your manager for review. You will be notified when they approve or reject it.', foundIn:'Task detail → Time Out button → Submit button', tip:'Always tap Time In before you start working — this is your proof of when you began.' },
        ]},
        { id:'2.5', title:'Completing the checklist', steps:[
          { summary:'Open your task and work through each checklist item', detail:'Open the task from your Dashboard and read through all checklist items before you start. Work through them in order, completing each one as you go.', foundIn:'Task detail → Checklist section', tip:'Complete checklist items in order and add photos as you go, not all at once at the end.' },
          { summary:'Tap Mark Done on each item when completed — if a timestamp icon is shown it will auto-record the exact time', detail:'Tap the Mark Done button or checkbox next to each checklist item as you complete it. If the item has a clock icon next to it, the exact time of completion is recorded automatically — this is used for compliance tracking.', foundIn:'Task detail → Checklist section → Mark Done button or checkbox; clock icon', pitfall:'If a checklist item has a mandatory asterisk you cannot submit the task without completing it.' },
          { summary:'Add a photo where the camera icon is shown — this is your evidence of completion', detail:'Some checklist items or the task itself require photo evidence. Tap the camera icon to take or upload a photo showing the completed work. Make sure the photo is clear, well-lit, and shows exactly what was required.', foundIn:'Task detail → Evidence section → camera icon', tip:'Complete checklist items in order and add photos as you go, not all at once at the end.' },
        ]},
        { id:'2.6', title:'What to do if your task is rejected', steps:[
          { summary:'You will see the task reappear in your Action Needed section with a Rejected status and comments from your supervisor', detail:'If your manager rejects your submission the task returns to your task list with a Rejected status. It will appear in your Action Needed section so you can find it quickly. The rejection will include comments from your supervisor explaining what needs to be fixed.', foundIn:'Dashboard → Action Needed section; task status → Rejected', tip:'Read the rejection comments carefully before resubmitting.' },
          { summary:'Read the comments, fix the issues, and resubmit the task', detail:'Open the rejected task and read the supervisor\'s comments carefully. Address every point raised — retake photos if needed, complete any missed checklist items, or redo the work. Once everything is fixed tap Submit to send it back for review.', foundIn:'Task detail → rejection comments; Submit button', pitfall:'Do not resubmit without addressing all the points in the rejection comments.' },
        ]},
      ]},
      { num:3, title:'Pitfalls to Avoid', subChapters:[
        { id:'3.1', title:'Common mistakes and how to avoid them', steps:[
          { summary:'Always time in before starting', detail:'The Time In stamp is your official record of when you started work on a task. If you forget to tap Time In and start working without it, the start time will be missing from your record. Your manager may question when the work was done. Make tapping Time In your first action every time you open a task to begin work.', foundIn:'Task detail → Time In button', tip:'Get into the habit: open the task, tap Time In, then start working. In that order, every time.' },
          { summary:'Make sure all mandatory checklist items are completed before submitting', detail:'Some checklist items are mandatory — they must be ticked before you can submit the task. If you try to submit with mandatory items still unticked the task will not go through. Work through the full checklist carefully and make sure every required item is completed before tapping Submit.', foundIn:'Task detail → Checklist section → mandatory items; Submit button', tip:'Scroll through the entire checklist before submitting to make sure nothing was missed — especially on long or complex tasks.' },
        ]},
      ]},
    ]
  },
